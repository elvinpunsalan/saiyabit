...
class DesignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create design" do
    assert_difference('Design.count') do
      post designs_url, params: { design: { description: @design.description, name: @design.name } }
    end
  ...
  test "should update design" do
    patch design_url(@design), params: { design: { description: @design.description, name: @design.name } }
